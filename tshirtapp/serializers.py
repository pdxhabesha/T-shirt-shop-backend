...
class SignupCustomerSerializer(serializers.ModelSerializer):
    email = serializers.EmailField(source='user.email', max_length=255, required=False)
    ...
    class Meta:
        ...
        # fields = ['email', "password", "username", "old_password", "first_name",  "is_customer", "is_admin"]
