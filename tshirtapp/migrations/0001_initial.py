# Generated by Django 2.2 on 2019-05-25 21:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Attribute', verbose_name='attribute_id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_attribute', models.ManyToManyField(default=1, to='tshirtapp.AttributeValue', verbose_name='product_attribute')),
                ('product_category', models.ManyToManyField(default=1, to='tshirtapp.Category', verbose_name='product_category')),
            ],
            options={
                'db_table': 'product',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Cart', verbose_name='cart_id')),
                ('product', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Product', verbose_name='product_id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_region', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.ShippingRegion', verbose_name='shipping_region_id')),
            ],
            options={
                'db_table': 'shipping',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Customer', verbose_name='customer_id')),
                ('product', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Product', verbose_name='product_id')),
            ],
            options={
                'db_table': 'review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Customer', verbose_name='customer_id')),
                ('shipping', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Shipping', verbose_name='shipping_id')),
                ('tax', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Tax', verbose_name='tax_id')),
            ],
            options={
                'db_table': 'orders',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Orders', verbose_name='order_id')),
                ('product', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Product', verbose_name='product_id')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, default=1, null=True, on_delete='CASCADE', to='tshirtapp.ShippingRegion', verbose_name='shipping_region'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
        ...
        migrations.AddField(
            model_name='category',
            name='department',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Department', verbose_name='department_id'),
        ),
        migrations.AddField(
            model_name='cart',
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Customer'),
        ),
        migrations.CreateModel(
            name='Audit',
            fields=[
                ...
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tshirtapp.Orders', verbose_name='order_id')),
            ],
            options={
                'db_table': 'audit',
            },
